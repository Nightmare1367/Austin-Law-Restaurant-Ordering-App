DESCRIPTION = {
        ...
        "Chicken Cutlet"        : ["A japanese dish which contains fried chicken made with panko crumbs, "
                                   ...
                                   "Flour, Panko Breadcrumbs, Chicken Breast, Eggs, Rice and an Assortment of Salad"],

        "Lasagna"               : ["Lasagna is a pasta dish which originates from italy and this dish"
                                   " is usually made with sheets of pasta with a special filling in between"
